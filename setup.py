...
setup(
    ...
    # la version du code
    version=master_package.__version__,
    ...
    entry_points = {
        'console_scripts': [
            'annee_bissextile-sm = master_package.annee_bissextile:annee_bissextile',
            'multiplication-sm = master_package.table_multiplication:multiplication',
